...
public class CreateAdmissionActionNodeHandler extends EMFCreateOperationHandler<CreateNodeOperation> {
    ...
    public CreateAdmissionActionNodeHandler() {
        super(HealthcareModelTypes.ADMISSION_ACTION);
    }
    ...
    @Override
    public String getLabel() { return "Admission Action"; }
    ...
    protected Command createActionAndShape(final Optional<GPoint> relativeLocation) {
        ...
        AdmissionAction newAction = createAction();
        Command actionCommand = AddCommand.create(editingDomain, actionCard,
            HealthcareDiagramPackage.Literals.ACTION_CARD__ADMISSION_ACTIONS, newAction);
    ...
    protected AdmissionAction createAction() {
        AdmissionAction newAction = HealthcareDiagramFactory.eINSTANCE.createAdmissionAction();
        newAction.setId(UUID.randomUUID().toString());
        setInitialName(newAction);
        return newAction;
    }

    protected void setInitialName(final AdmissionAction action) {
