 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.glsp.example.healthcareDiagram.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiableImpl extends MinimalEObjectImpl.Container implements Identifiable {
   ...
   protected EClass eStaticClass() {
      return HealthcareDiagramPackage.Literals.IDENTIFIABLE;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, HealthcareDiagramPackage.IDENTIFIABLE__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case HealthcareDiagramPackage.IDENTIFIABLE__ID:
            return getId();
      }
